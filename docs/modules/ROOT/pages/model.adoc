...
image::/model/example.svg[alt="the model example", width=790px, role=center]
...
image::/model/decoupling.svg[alt="decoupling", width=860px, role=center]
...
image::/model/fan_out.svg[alt="fan out", width=804px, role=center]
