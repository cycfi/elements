...
namespace photon
{
   ...
   // Vertical Tiles
   ////////////////////////////////////////////////////////////////////////////////////////////////
   rect vtile_widget::limits(theme const& th) const
   {
   ...
   void vtile_widget::layout(theme const& th, rect const& b)
   {
      _left = b.left;
      _right = b.right;
      ...
      for (auto const& elem : elements())
      {
         ...
         *i++ = curr;
         ...
         elem->layout(th, { _left, prev, _right, curr });
      }
      *i = curr;
   }

   rect vtile_widget::bounds_of(theme const& th, std::size_t index) const
   {
   ...
   // Horizontal Tiles
   ////////////////////////////////////////////////////////////////////////////////////////////////
   rect htile_widget::limits(theme const& th) const
   {
   ...
   void htile_widget::layout(theme const& th, rect const& b)
   {
      _top = b.top;
      _bottom = b.bottom;
      ...
      for (auto const& elem : elements())
      {
         ...
         *i++ = curr;
         ...
         elem->layout(th, { prev, _top, curr, _bottom });
      }
      *i = curr;
   }

   rect htile_widget::bounds_of(theme const& th, std::size_t index) const
   {
